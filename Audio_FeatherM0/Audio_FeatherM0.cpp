/*
  Copyright (c) 2016 Theo Meyer aka AloyseTech. With subsequent 
  modifications by various people including Peter Bradley aka Gambalunga. 
  All right reserved.
...
void SamdAudio::play(const char *fname, uint8_t channel) {
    ...
    __audioFile[channel] = fatfs.open(fname);
